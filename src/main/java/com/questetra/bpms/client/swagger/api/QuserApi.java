...
public class QuserApi {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call deleteCall(Long id, BigDecimal delegateQuserId, BigDecimal delegateQgroupId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call deleteValidateBeforeCall(Long id, BigDecimal delegateQuserId, BigDecimal delegateQgroupId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public void delete(Long id, BigDecimal delegateQuserId, BigDecimal delegateQgroupId) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> deleteWithHttpInfo(Long id, BigDecimal delegateQuserId, BigDecimal delegateQgroupId) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call deleteAsync(Long id, BigDecimal delegateQuserId, BigDecimal delegateQgroupId, final ApiCallback<Void> callback) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public QuserWrapper update(Long id, String name, String email, String password, Long primaryQgroupId) throws ApiException {
        ApiResponse<QuserWrapper> resp = updateWithHttpInfo(id, name, email, password, primaryQgroupId);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<QuserWrapper> updateWithHttpInfo(Long id, String name, String email, String password, Long primaryQgroupId) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call updateAsync(Long id, String name, String email, String password, Long primaryQgroupId, final ApiCallback<QuserWrapper> callback) throws ApiException {
