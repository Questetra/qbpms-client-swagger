...
import com.questetra.bpms.client.swagger.auth.Authentication;
import com.questetra.bpms.client.swagger.auth.HttpBasicAuth;
import com.questetra.bpms.client.swagger.auth.ApiKeyAuth;
import com.questetra.bpms.client.swagger.auth.OAuth;
...
public class ApiClient {
    ...
    private String basePath = "https://online-demo-en.questetra.net/";
    ...
    public ApiClient() {
        ...
        setUserAgent("Swagger-Codegen/11.5.0.developing/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://online-demo-en.questetra.net/
