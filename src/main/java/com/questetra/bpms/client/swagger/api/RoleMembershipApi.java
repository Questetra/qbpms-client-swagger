...
public class RoleMembershipApi {
     ...
     */
    public RoleMembership add(Long quserId, Long qroleId) throws ApiException {
        ApiResponse<RoleMembership> resp = addWithHttpInfo(quserId, qroleId);
        return resp.getData();
    }
     ...
     * @param quserId User ID (required)
     * @param qroleId Role ID (required)
     * @return ApiResponse&lt;RoleMembership&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<RoleMembership> addWithHttpInfo(Long quserId, Long qroleId) throws ApiException {
        com.squareup.okhttp.Call call = addValidateBeforeCall(quserId, qroleId, null, null);
        Type localVarReturnType = new TypeToken<RoleMembership>(){}.getType();
     ...
     */
    public com.squareup.okhttp.Call addAsync(Long quserId, Long qroleId, final ApiCallback<RoleMembership> callback) throws ApiException {
