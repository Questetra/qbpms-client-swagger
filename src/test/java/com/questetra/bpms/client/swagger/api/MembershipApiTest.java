...
public class MembershipApiTest {
    ...
    public void addMembershipTest() throws ApiException {
        ...
        Long qgroupId = null;
        String role = null;
        MembershipWrapper response = api.addMembership(quserId, qgroupId, role);
    ...
    public void deleteMembershipTest() throws ApiException {
        Long quserId = null;
        Long qgroupId = null;
        api.deleteMembership(quserId, qgroupId);
     ...
     */
    @Test
    public void listMembershipsByQgroupTest() throws ApiException {
        Long id = null;
        MembershipList response = api.listMembershipsByQgroup(id);
     ...
     */
    @Test
    public void listMembershipsByQuserTest() throws ApiException {
        Long id = null;
        MembershipList response = api.listMembershipsByQuser(id);
    ...
    public void updateMembershipTest() throws ApiException {
        ...
        Long qgroupId = null;
        String role = null;
        MembershipWrapper response = api.updateMembership(quserId, qgroupId, role);
